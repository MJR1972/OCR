...
- `Tables`
  ...
  - Multiline table cell content should remain readable in table inspection views rather than being forcibly flattened to one line.
...
- When table string values contain embedded line breaks, the viewer should preserve and wrap them for human review.
